...
func main() {
    ...
    var guess int
    var retryCount int
    var randomRangeStart int = 0
    var randomRangeEnd  int = 10

     // the program will prompt the player to take retry count
        fmt.Println("Please enter your number")

fmt.Println("You have three(", retryCount, ") tries ")
   ...
   // randomRangeEnd = 100
   // }
    secretNumber := randomizer.Intn(randomRangeEnd - randomRangeStart) + randomRangeStart  // generate numbers between 0 and 10 only
